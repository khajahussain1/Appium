...
public class Tutorial23 {
	...
	@BeforeMethod
	public void setup(@Optional("7") String verion) throws MalformedURLException {
		...
		if (verion.equals("4.4.4")) {
			cap.setCapability("udid", "LC62TYT08029");
		} else if (verion.equals("7")) {
			cap.setCapability("udid", "c4e19a117d94");
		}
